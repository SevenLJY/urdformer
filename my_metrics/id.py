...
def ID(gen_obj_dict, gen_obj_path, gt_obj_dict, gt_obj_path, num_states=5, num_samples=2048):
    """
    ...
    gen_obj_part_ply_paths = [{"dir": gen_obj_path, "files": gen_obj_dict["diffuse_tree"][i]["plys"]} 
                             for i in range(gen_obj_num_parts)]
    gt_obj_part_ply_paths = [{"dir": gt_obj_path, "files": gt_obj_dict["diffuse_tree"][i]["plys"]} 
